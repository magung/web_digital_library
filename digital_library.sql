...
--
-- Host: localhost
-- Generation Time: Nov 16, 2020 at 04:38 PM
...
(1, 'BUKU WEB', 'Mr. Programmer', 'Hikam Pustaka', '000-000-000-001', '000-000-000-000', '2020', 97, 'Sebagai seorang Web Design atau Programmer belajar adalah suatu hal yang di haruskan, karena dengan belajar kita akan menjadi seorang yang ahli di bidang Web Design atau Programmer. Belajar bisa di lakukan dengan banyak cara, contohnya seperti searching di internet tentang tutorial, artikel, video yang berhubungan dengan apa yang kita mau pelajari, atau bertanya dengan teman yang sudah ahli di bidang yang ingin kita pelajari, atau mencari buku-buku referensi di toko-toko buku untuk mempelajari apa yang ingin kita pelajari, dan sebagainya.', '5f8acad6df275.png', 1, 1, '2020-11-15 18:47:40'),
(2, 'BUku judul baru', 'tes', 'tes', 'tes', 'tes', '2020', 80, 'tes', '5f8acabb89a7d.png', 2, 1, '2020-11-14 21:24:42'),
...
INSERT INTO `members` (`id_member`, `nama`, `email`, `no_wa`, `image`, `alamat`, `password`, `status_pekerjaan`, `jenis_kelamin`) VALUES
(1, 'Agung', 'agung040100@gmail.com', '+62 895-7009-96565', '-', 'jl kesana kesini', '', 'mahasiswa', 'Laki-Laki'),
(2, 'Hanif', 'hanif@gmail.com', '088704145010', '-', 'jl jalan-jalan aja', '', 'mahasiswa', 'Laki-Laki'),
(3, 'Sumi', 'sumi@gmail.com', '088704145111', '-', 'jl jalan terus', '', 'mahasiswa', 'Perempuan');
...
(4, '3', 3, 1, 1, '2', 'KONFIRMASI', '-', '2020-10-24', '2020-10-30', NULL, '2020-11-02 22:14:02', 0),
...
(1, 'Admin', 'admin', 'e10adc3949ba59abbe56e057f20f883e', 13),
