    ...
    <div class="d-flex align-items-stretch">
      <div id="sidebar" class="sidebar py-3">
        ...
        <ul class="sidebar-menu list-unstyled">
            ...
            <li class="sidebar-list-item"><a href="members.php" class="sidebar-link text-muted active"><i class="fas fa-user-friends mr-3 text-gray"></i><span>Members</span></a></li>
                      ...
                      <?php
                        ...
                        while($d=mysqli_fetch_array($sql)){
                          echo "<tr id='search'>
                                  ...
                                  <td>$d[alamat]</td>
                                  <td>
                                  <a class='btn btn-success btn-sm' href='anggota_edit.php?id=$d[id_member]'>
