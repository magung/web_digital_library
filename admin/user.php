            ...
            <section class="py-5">
                ...
                <div class="card">
                  <div class="card-header">
                    <h6 class="text-uppercase mb-0">Data User Admin</h6>
                  </div>
                  <div class="card-body">                           
                      ...
                      <?php
                        ...
                        while($d=mysqli_fetch_array($sql)){
                          echo "<tr id='search'>
                                  ...
                                  <td>$d[nama]</td>
                                  <td>
                                  <a class='btn btn-success btn-sm' href='anggota_edit.php?id=$d[id_user]'>
                                  <i class='fas fa-edit'></i></a>
                                  <a href='#myModal' class='hapus-pejabat btn btn-danger btn-sm' data-id='$d[id_user]' 
