$(function () {
   ...
   var myPieChart = new Chart(PIECHART, {
    ...
    var PIECHARTPEMINJAMAN    = $('#pieChartPeminjaman');
    // var konfirmasi = $konfirmasi;
    console.log(konfirmasi)
    var pieChartPeminjaman = new Chart(PIECHARTPEMINJAMAN, {
        type: 'pie',
        data: {
            labels: [
                "Menunggu Konfirmasi",
            ...
            datasets: [
                {
                    data: [konfirmasi, dikirim, terkirim, dipinjam, selesai, batal],
                    borderWidth: 0,
                    backgroundColor: [
                        "#F2E357",
                        "#558FF7",
